    ...
    <section class="step-container">
      ...
      <div class="step-actions">
        ...
        <div class="step-content">
          <h3>Required</h3>
          <p>
            Each project added requires a <strong>README</strong> file added to their project’s root directory that
            ...
            process for writing documentation. After you’re done, you can copy and paste your content into your <strong>README</strong> file!
          </p>
          <h3>Example:</h3>
